...
final String applicationName_tMongoDBOutput_1 = "Talend";
    ...
    com.mongodb.client.MongoDatabase db_tMongoDBOutput_1=null;
        ...
        db_tMongoDBOutput_1.getCollection(context.mongo_collection_bronze).drop();
    com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBOutput_1 = db_tMongoDBOutput_1.getCollection(context.mongo_collection_bronze);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = context.source;
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.source, "UTF-8",";","\n",true,1,0,
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)(context.source) instanceof java.io.InputStream)){
...
/************************************************************************************************
 *     89695 characters generated by Talend Open Studio for Big Data 
 *     on the 4 décembre 2025 à 18:35:54 CET
 ************************************************************************************************/