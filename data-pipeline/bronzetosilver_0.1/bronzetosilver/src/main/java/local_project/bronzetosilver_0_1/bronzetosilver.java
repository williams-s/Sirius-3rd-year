...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(mongo_collection_kpia != null){
				
					this.setProperty("mongo_collection_kpia", mongo_collection_kpia.toString());
...
public String mongo_collection_kpia;
public String getMongo_collection_kpia(){
	return this.mongo_collection_kpia;
}
...
final String applicationName_tMongoDBOutput_1 = "Talend";
    ...
    com.mongodb.client.MongoDatabase db_tMongoDBOutput_1=null;
        ...
        db_tMongoDBOutput_1.getCollection(context.mongo_collection_kpia).drop();
    com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBOutput_1 = db_tMongoDBOutput_1.getCollection(context.mongo_collection_kpia);
 ...
 */
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row8,row7,row3) outputs:(sortieee)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        context.setContextType("mongo_collection_kpia", "id_String");
                        if(context.getStringValue("mongo_collection_kpia") == null) {
                            context.mongo_collection_kpia = null;
                        } else {
                            context.mongo_collection_kpia=(String) context.getProperty("mongo_collection_kpia");
                        }
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("mongo_server")) {
            ...
            }if (parentContextMap.containsKey("mongo_collection_kpia")) {
                context.mongo_collection_kpia = (String) parentContextMap.get("mongo_collection_kpia");
...
/************************************************************************************************
 *     291583 characters generated by Talend Open Studio for Big Data 
 *     on the 24 février 2026 à 17:59:07 CET
 ************************************************************************************************/