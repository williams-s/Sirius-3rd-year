 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = test.class.getClassLoader().getResourceAsStream("local_project/test_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     221988 characters generated by Talend Open Studio for Big Data 
 *     on the 17 février 2026 à 17:38:51 CET
 ************************************************************************************************/